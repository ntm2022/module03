...
import com.jstlexamples.model.DBUtils;
import com.jstlexamples.model.Dept;
...
@WebServlet(name = "JstlCoreEx02Servlet", value = "/jstlCoreExample02")
public class JstlCoreEx02Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = getServletContext()
                .getRequestDispatcher("/jsps/jstl_core_example02.jsp");
